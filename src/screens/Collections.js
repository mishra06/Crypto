...
//   useEffect(() => {
//     if (prevPysaRef.current !== pysa) {
//       GetData();
//       prevPysaRef.current = pysa;
//     }
//   }, [pysa, GetData]);
...
//             return false;
//           }).map((coins, i) => (
//             <CoinsCard key={i} coins={coins} id={coins.id} PRICES={PRICES} />
//           ))
//         }
//       </div>
//     </>
...
// const CoinsCard = ({ coins, PRICES, id }) => {
//   const profitRate = coins.price_change_percentage_24h > 0;
//   return (
//     <NavLink to={`/collections/${id}`} style={{ textDecoration: "none", color: 'yellow' }}>
